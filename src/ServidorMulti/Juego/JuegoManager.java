...
public class JuegoManager {
    ...
    // Obtiene CUALQUIER partida en la que esté un jugador (usado principalmente para verificar si puede mover)
    ...
    // Nuevo método para obtener una partida ESPECÍFICA entre dos jugadores (para la nueva lógica de movimiento)
    ...
    public static boolean invitar(String proponente, String oponente) throws IOException {
        // Solo falla si ya hay una partida activa CON ESTE OPONENTE
    ...
    public static JuegoGato iniciarPartida(String proponente, String aceptante) throws IOException {
        ...
        // Doble verificación: no iniciar si ya existe partida entre ellos
    ...
    // --- LÓGICA DE MOVIMIENTO CORREGIDA PARA MÚLTIPLES PARTIDAS ---
    public static void procesarMovimiento(String jugador, String oponente, int posicion) throws IOException {
        // Usamos obtenerPartidaCon para encontrar la partida EXACTA
    ...
    private static void verificarFinJuego(String j1, String j2, JuegoGato juego) throws IOException {
        ...
        if (estado.startsWith("GANADOR")) {
            ...
            mensaje = "[JUEGO GATO vs " + j2 + "] ¡Felicidades " + ganador + "! Ganaste contra " + juego.getOponente(ganador) + ".";
        } else { // EMPATE
    ...
    // --- LÓGICA DE REVANCHA (Doble Confirmación) ---
    private static void solicitarRevancha(String j1, String j2) throws IOException {
        ...
        enviarMensaje(j2, mensajeRevancha.replace(j2, j1)); // Mensaje dinámico para j2
    }
    ...
    private static void aceptarRevancha(String idRevancha, String jugadorQueAcepta, String oponente) throws IOException {
        ...
        if (estadoActual.equals("PENDIENTE")) {
            ...
            enviarMensaje(jugadorQueAcepta, "[REVANCHA vs " + oponente + "] Aceptaste. Esperando la respuesta de " + oponente + ".");
            enviarMensaje(oponente, "[REVANCHA vs " + jugadorQueAcepta + "] " + jugadorQueAcepta + " ha aceptado. Responde /si o /no para iniciar.");
            ...
            String j2 = oponente; // Jugador que aceptó de primero
    ...
    public static void forzarRendicion(String jugador) throws IOException {
        ...
        for (String id : partidasActivas.keySet()) {
            if (id.contains(jugador)) {
                JuegoGato juego = partidasActivas.get(id);
